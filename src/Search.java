...
public class Search {
    ...
    public  void searchFirstName(String firstName){
        ...
        boolean[] contactFound = new boolean[Contact.contacts.length];
        boolean print = false;

        for (int i = 0; i < Contact.contacts.length; i++) {

            if(Contact.contacts[i].getFirstName().toLowerCase().equals(firstName)){
        ...
        if (print){
            ...
            for (int i = 0; i < contactFound.length; i++) {
                ...
                if (contactFound[i]){
                    ...
                    Contact.contacts[i].displayContact();
                }
            }
        }
        else{
    ...
    public  void searchAddress(String address){
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getAddress().toLowerCase().equals(address)){
    ...
    public  void freeSearch(String text){
        ...
        boolean[] contactMatching = new boolean[Contact.contacts.length];
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getFirstName().toLowerCase().equals(text)) {
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getLastName().toLowerCase().contains(text)) {
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getAddress().toLowerCase().contains(text)) {
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getNumber().contains(text)) {
        ...
        for (int i = 0; i < Contact.contacts.length; i++) {
            ...
            if(Contact.contacts[i].getAge().contains(text)) {
